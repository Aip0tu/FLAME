...
from FLAME_plugin.args import TrainArgs
from FLAME_plugin.dataprocess.features import BatchMolGraph, get_atom_fdim, get_bond_fdim, mol2graph
from FLAME_plugin.nn_utils import index_select_ND, get_activation_function
...
#         self.trans = nn.Linear(728,2000)
#         self.trans = nn.Embedding()
